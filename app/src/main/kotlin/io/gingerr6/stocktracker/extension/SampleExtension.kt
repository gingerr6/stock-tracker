...
import io.gingerr6.stocktracker.MainActivity
...
class SampleExtension : KarooExtension("sample", "1.0") {
    ...
    override val types by lazy {
        ...
        ) + (1..10).map { StockPriceDataType(karooSystem, this, extension, it) } + StockRollingDataType(karooSystem, this, extension)
    }
                ...
                if (connected) {
                    ...
                    karooSystem.dispatch(
                        SystemNotification(
                            ...
                            message,
                            action = "See it",
                            actionIntent = "io.gingerr6.stocktracker.MAIN",
                        ),
                    )
                }
            }
